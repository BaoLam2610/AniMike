...
// TrackingStatusBar (Detail) + filter chips/badge (màn "Danh sách"). Mỗi trạng
// thái 1 màu ngữ nghĩa riêng (như ReviewTagBadge 3 màu): Đang xem = success
// (đang "sống"), Đã xem = tertiary (hoàn tất, thông tin), Tạm dừng = rankGold
// (hổ phách — cảnh báo nhẹ, tái dùng token medal), Bỏ = error, Dự định xem =
// primary (hướng tới tương lai — accent chính).
